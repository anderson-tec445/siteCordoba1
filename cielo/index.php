...
<body class="bg-light">
  ...
  <div class="container-cordoba">
    <div class="py-5 text-center">
      <a href="../../index.php">
        <img src="../img/cordoba-logo.png" width="200">
      </a>
    </div>
  </div>
          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            <div class="">
              <div class="checkout__order">
                <h4>Sua Compra</h4>
                <div class="checkout__order__products flex">Produtos <span>Total</span></div>
                <ul>
                  ...
                  ?>
                    <li class="flex"><?php echo $nome_produto ?> <span>R$<?php echo $total_item ?></span></li>

                    <?php if ($valor_frete > 0) { ?>
                      <p align="right" class="text-danger flex"><small>Frete Fixo : <?php echo $valor_frete ?></small></p>
                    <?php } ?>
                ...
                <div class="checkout__order__subtotal flex">Subtotal <span>R$ <?php echo $total ?></span></div>
                  ...
                  <div class="checkout__order__total">Calcular Frete<br>
                    <div class="checkout__input py-2">
                      ...
                      <form id="frm" method="post">
                        ...
                        <div class="row">
                          <div class="col-md-7">
                            <input class="inputs" type="hidden" value="<?php echo @$total_peso ?>" name="total_peso" id="total_peso">

                            <div class="checkout__input">
                              <input class="inputs" type="text" name="cep2" id="cep2" placeholder="CEP">
                            </div>
                          </div>
                          <div class="col-md-5">
                            <div class="checkout__input">
                              <select name="codigo_servico" id="codigo_servico" class="inputs"> 
